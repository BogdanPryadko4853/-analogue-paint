...
#include "../../../src/brushtool/brushtool.h"
...
static constexpr auto qt_meta_stringdata_ZN9BrushToolE = QtMocHelpers::stringData(
    "BrushTool"
);
...
Q_CONSTINIT static const uint qt_meta_data_ZN9BrushToolE[] = {
...
Q_CONSTINIT const QMetaObject BrushTool::staticMetaObject = { {
    ...
    qt_meta_stringdata_ZN9BrushToolE.offsetsAndSizes,
    qt_meta_data_ZN9BrushToolE,
    qt_static_metacall,
    nullptr,
    qt_incomplete_metaTypeArray<qt_meta_tag_ZN9BrushToolE_t,
        // Q_OBJECT / Q_GADGET
...
void *BrushTool::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_ZN9BrushToolE.stringdata0))
